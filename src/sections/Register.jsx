...
const Register = () => {
  return (
    <div className="flex justify-center items-center bg-[url('./assets/img/login.jpg')] bg-cover bg-no-repeat bg-center w-full min-h-screen">
      <section className="flex flex-col justify-center items-center gap-[37px] bg-dark-primary opacity-80 p-[40px] rounded-[16px] w-[529px] h-[778px] font-lato">
        <img src={dataIcons.logo} alt="Movie Logo" className="bg-cover w-[94px] md:w-[163px] h-[24px] md:h-[44px]" />
        <div className="flex flex-col justify-center items-center gap-[8px]">
          <h3 className="font-regular font-normal font-bold text-[32px] text-light-white">Daftar</h3>
          <p className="text-[16px] text-light-white">Selamat datang!</p>
        </div>
        <form action="#" className="flex flex-col gap-[37px] w-full">
          ...
          <div className="flex flex-col justify-center items-start gap-[6px]">
            ...
            <p className="mt-[12px] font-medium text-[16px] text-light-primary">
              Sudah punya akun?{' '}
              <Link to="/login" className="font-medium text-[16px] text-light-white hover:underline pointer">
                Masuk
              </Link>
            </p>
          </div>
